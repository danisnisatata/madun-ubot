...
async def _(client, message):
    ...
    sh = await message.reply("""<u><b>🏷 Join Reseller: 5.000 </b></u>
...
<blockquote>{bot.me.mention}
    status: {status} 
       {psr} expired_on: {exp} 
        ...
        <blockquote><b>ᴜʙᴏᴛ ʟᴇʟᴇɴ ᴘʀᴇᴍɪᴜᴍ</b></blockquote>
"""
...
#    os.execl(sys.executable, sys.executable, "-m", "ᴜʙᴏᴛ MADUN ᴀᴅᴜʜᴀʏ")
...
async def user_help_inline(client, inline_query):
    ...
    try:
        ...
        caption = (
            ...
            f"ᴘʀᴇꜰɪx: {' '.join(SH)}\n"
            f"ᴍʏ ᴜʙᴏᴛ: <a href=t.me/ubotfreemadunbot>ubotfreemadunbot</a>"
            f"</b></blockquote>"
        )
        ...
        results = [
            ...
            InlineQueryResultPhoto(
                ...
                photo_url="https://ibb.co.com/20CFtTx5",

                thumb_url="https://ibb.co.com/20CFtTx5",
