...
__HELP__ = """
<blockquote><b>⦪ ʙᴀɴᴛᴜᴀɴ ᴜɴᴛᴜᴋ ss ᴡᴇʙ ᴛᴀʙʟᴇᴛ ⦫</b>

<b>⎆ ᴘᴇʀɪɴᴛᴀʜ :</b>
ᚗ <code>{0}ssᴡᴇʙᴛᴀʙʟᴇᴛ</code> [ʟɪɴᴋ]

<b>⌭ ᴘᴇɴᴊᴇʟᴀsᴀɴ:</b>
ᚗ ᴍᴇɴɢᴀᴍʙɪʟ sᴄʀᴇᴇɴsʜᴏᴛ ᴡᴇʙsɪᴛᴇ ᴅᴇɴɢᴀɴ ᴛᴀᴍᴘɪʟᴀɴ ᴛᴀʙʟᴇᴛ ᴋɪɴɢᴢ.</blockquote>
"""
...
async def screenshot_handler(client, message):
    ...
    status_msg = await message.reply_text(f"<blockquote><b>{prs} ᴘʀᴏsᴇs sᴄʀᴇᴇɴsʜᴏᴛ ᴛᴀʙʟᴇᴛ ᴋɪɴɢᴢ...</b></blockquote>")

    image_data = get_ssweb_image(url)
    if not image_data:
        return await status_msg.edit(f"<blockquote><b>{ggl} ɢᴀɢᴀʟ ᴍᴇɴɢᴀᴍʙɪʟ sᴄʀᴇᴇɴsʜᴏᴛ.</b></blockquote>")

    filepath = "ss_tablet.jpg"
    ...
    await client.send_photo(
        message.chat.id, 
        photo=filepath, 
        caption=f"<blockquote><b>{brhsl} ss ᴡᴇʙ ᴛᴀʙʟᴇᴛ sᴇʟᴇsᴀɪ</b>\nᚗ ᴛᴀᴜᴛᴀɴ : <code>{url}</code></blockquote>",
